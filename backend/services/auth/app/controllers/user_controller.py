...
class UserController(BaseController):
  ...
  def __init__(self, get_user_usecase: BaseUseCase, edit_user_usecase: BaseUseCase, delete_user_usecase: BaseUseCase) -> None:
    super().__init__()
  ...
  def convert_to_dto(self, data: dict) -> UserEditDto:
    return UserEditDto(user_name=data.get('user_name'), 

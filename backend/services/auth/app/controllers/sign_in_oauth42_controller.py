...
class SignInOAuth42Controller(BaseOAuth42Controller):
    ...
    def __init__(
        ...
        get_access_token_42_use_case: BaseUseCase,
        validate_access_token_42_use_case: BaseUseCase,
        get_me_42_use_case: BaseUseCase,
        sign_in_oauth42_service: BaseService,
    ) -> None:
    ...
    async def handle_callback(self, request: HttpRequest) -> JsonResponse:
        ...
        sign_in_up_oath42 = SignInUpOAuth42Dto(
            email=me_data["email"],
            user_name=me_data["login"],

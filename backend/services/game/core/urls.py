...
urlpatterns = [
    ...
    path("view-user-games/<uuid:pk>", views.GamesView.as_view(), name="view_user_games"),

    path("game", views.AddGameView.as_view(), name="add_game"),
    path("game-validation/<int:pk>", views.ValidateGameView.as_view(), name="validate_game"),

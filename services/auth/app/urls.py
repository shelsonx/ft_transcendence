...
urlpatterns = [
    ...
    path("sign-in-42/", SignInOAuth42View.as_view(sign_in_oauth42_controller=sign_in_oauth42_controller, http_client=http_client,get_access_token_42_use_case=get_access_token_42_use_case,validate_access_token_42_use_case=validate_access_token_42_use_case, get_me_42_use_case=get_me_42_use_case)
    )
]